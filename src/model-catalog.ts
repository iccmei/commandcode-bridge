...
export const COMMANDCODE_MODEL_DEFINITIONS: CommandCodeModelDefinition[] = [
  ...
  },
  {
    ...
    provider: "Z.ai",
    family: "glm",
    aliases: ["glm-5.3-flash", "GLM-5.3-Flash", "zai/glm-5.3-flash"],
    contextWindow: 1_048_576,
    enabledByDefault: false,
    notes: "$0.15/M in · $0.5/M out",
  },
  {
    id: "zai-org/GLM-5.3",
    label: "GLM 5.3",
  ...
  },
  {
    ...
    provider: "Qwen",
    family: "qwen",
    aliases: ["qwen3.8-flash", "Qwen3.8-Flash", "alibaba/qwen3.8-flash"],
    contextWindow: 1_000_000,
    enabledByDefault: false,
    notes: "$0.16/M in · $0.47/M out",
  },
  {
    id: "Qwen/Qwen3.7-Max",
    label: "Qwen 3.7 Max",
